...
<div class="container-fluid">
    <header class="d-flex flex-wrap  align-items-center justify-content-center justify-content-md-between py-4 mb-4 border-bottom" style="font-size: 22px">
      ...
      <div class="col-md-2 text-right">
        <a href="cart.php" class="btn btn-outline-info"> <span class="bi bi-cart"></i></a>
        <a class="btn btn-info" style="color:white; text-decoration: none"><?php echo $_SESSION['user_name']; ?></a> 
